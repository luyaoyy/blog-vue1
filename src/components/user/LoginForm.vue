    ...
    <el-dialog
      ...
      <form class="form_container">
        ...
        <div class="input_container">
          ...
          <input placeholder="Username" title="Inpit title" name="input-name" type="text" class="input_field"
                 id="email_field" v-model="form.username">
        </div>
        <div class="input_container">
          ...
          <input placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field"
                 id="password_field" v-model="form.password" @keyup.enter="login">
        </div>
        <button title="Sign In" type="button" class="sign-in_btn"  @click="login">
          <span>Sign In</span>
        </button>
      </form>
    </el-dialog>
...
<style scoped>
@import url('../../assets/css/user/LoginForm.css');
</style>